export function Section_3(props) {
  return (
    <div className="bg-white w-full h-[90vh] flex justify-center items-center  md:px-0">
      
      {/* Inner container */}
      <div className="w-full h-[80%] bg-[#EEEEEE] lg:bg-[linear-gradient(to_left,#EEEEEE_74%,white_74%)] flex flex-col-reverse lg:flex-row-reverse justify-between items-center py-10">
        ...
        <div className="flex flex-col w-full lg:w-[40%] items-start text-left pt-20 lg:items-start justify-center gap-6 lg:gap-7 px-4 lg:px-40 text-center lg:text-left">
          ...
          <button className="border-b-2 border-black hover:border-[#EEEEEE] mt-2 px-4 py-2">
            Show Now
          </button>
        </div>
        ...
        {/* Right Image Section */}
        <img
          src={props.section3_content.image}
          alt=""
          className="w-full lg:w-[55%] h-[50%] sm:h-[60%] lg:h-[70%] object-contain filter  mt-6 lg:mt-0"
        />
